        <div class="row">
          <div class="col s12 m9">
            <h3 class="blue-text"style="text-align:left;"><b> Registrasi Masyarakat</h3></b>
          </div>  
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn modal-trigger blue" href="#modal1" style="margin-left:200px; margin-top:10px;"><i class="material-icons">add</i></a>
          </div>
        </div>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="regis_edit?nik=<?php echo $r['nik'] ?>" class="modal">
          ...
          <div class="modal-footer">
            <a href="#!" class="modal-close waves-effect waves-green btn-flat" style="margin-left:100px;"><b>Tutup</a></b>
          </div>
        </div>
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
