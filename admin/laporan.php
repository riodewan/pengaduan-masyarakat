        <div class="row">
          <div class="col s12 m9">
            <h3 class="blue-text"style="text-align:left;"><b>Cetak Laporan</h3></b>
          </div> 
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn blue" href="cetak.php" style="margin-left:200px; margin-top:10px;"><i class="material-icons">print</i></a>
          </div>
        </div>
