<div class="container">
	<table class="responsive-table" border="2" style="width: 100%;">
		<tr>
			<td><h4 class="black-text hide-on-med-and-down" style="text-align : center; margin-right:120px;"> <b> Tulis Laporan</h4></td></b>
		</tr>
		<tr>
			<td style="padding: 20px; margin-left:100px;">
		...
		<div class="container">
			...
			<td><h4 class="black-text hide-on-med-and-down" style="text-align : center; margin-right: -700px; margin-top:100px; margin-left:10px;"> <b>Daftar Laporan</h4></td></b>
				<tr>
					<td><b>No</td></b>
					<td><b>NIK</td></b>
					<td><b>Nama</td></b>
